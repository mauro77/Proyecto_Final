...
/**
 * Created by Cristian on 13/07/2015.
 */

    public class Rutas extends FragmentActivity implements
        ...
        LocationListener
    {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mMap = ((MapFragment)getFragmentManager().findFragmentById(R.id.ruta)).getMap();
            mMap.setMapType(GoogleMap.MAP_TYPE_HYBRID);
            cameraUpdate = CameraUpdateFactory.newLatLngZoom(MEDELLIN_LOCATION, 14);
